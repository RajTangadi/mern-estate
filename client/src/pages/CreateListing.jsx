const CreateListing = () => {
  return (
    <main className="p-3 max-w-4xl mx-auto">
      ...
      <form className="flex flex-col sm:flex-row space-x-5">
        ...
        <div className="flex flex-col flex-1 gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button className="p-3 border text-green-700 border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">Upload</button>
          </div>
